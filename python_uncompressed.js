...
Blockly.Python.init = function(a) {
    ...
    var b = [];
    a = a.variableList;
    for (var c = 0; c < a.length; c++) b[c] = "int " + Blockly.Python.variableDB_.getName(a[c], Blockly.Variables.NAME_TYPE) + " = 0;";
...
Blockly.Python.math_single = function(a) {
    var b = a.getFieldValue("OP"),
        c;
    if ("NEG" == b) return c = Blockly.Python.valueToCode(a, "NUM", Blockly.Python.ORDER_UNARY_SIGN) || "0", ["-" + c, Blockly.Python.ORDER_UNARY_SIGN];
...
Blockly.Python.procedures_defreturn = function(a) {
    for (var b = [], c = 0, d; d = a.workspace.variableList[c]; c++) - 1 == a.arguments_.indexOf(d) && b.push(Blockly.Python.variableDB_.getName(d, Blockly.Variables.NAME_TYPE));
...
Blockly.Python.text_join = function(a) {
    switch (a.itemCount_) {
        ...
        default:
            for (var b = [], c = 0; c < a.itemCount_; c++) b[c] =
...
Blockly.Python.controls_repeat_ext = function(a) {
    ...
    return "for (int i=0; " + Blockly.Python.variableDB_.getDistinctName("count", Blockly.Variables.NAME_TYPE) + " i<" + b + "; i++) {\n" + c + "}\n"
};
...
Blockly.Python.controls_if = function(a) {
    var b = 0,
        c = "",
        d, e;
    do e = Blockly.Python.valueToCode(a, "IF" + b, Blockly.Python.ORDER_NONE) || "false", d = Blockly.Python.statementToCode(a, "DO" + b) || Blockly.Python.PASS, c += (0 == b ? "if " : "elif ") + e + ":\n" + d, ++b; while (a.getInput("IF" + b));
