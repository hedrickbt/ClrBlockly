...
Blockly.Arduino['setuploop'] = function(block) {
  includes = "//Includes\n";
  ...
  var loopCode  = Blockly.Arduino.statementToCode(block, 'LOOPCODE' );
  
  // Get the associated code for blocks in the setup area
  var setCode = Blockly.Arduino.statementToCode (block, 'SETUPCODE' );
...
Blockly.Arduino['setcolor'] = function(block) {
  var color = block.getFieldValue('COLOR');
  var object = Blockly.Arduino.valueToCode(block, 'OBJECT', Blockly.Arduino.ORDER_ATOMIC);
  var uniqueName = insideChars ( object,"\"","\"");
  var code = uniqueName + '.setColor (' + color + ');\n';
  return code;
};

Blockly.Arduino['flashcolor'] = function(block) {
  var object = Blockly.Arduino.valueToCode(block, 'NAME', Blockly.Arduino.ORDER_ATOMIC);
  var color = block.getFieldValue('COLOR');
  var uniqueName = insideChars (object,"\"","\"");
...
Blockly.Arduino['statement'] = function(block) {
  var statementValue = Blockly.Arduino.valueToCode(block, 'statementValue', Blockly.Arduino.ORDER_ATOMIC);
  var code = insideChars (statementValue,"\"","\"");
  return code + '\n'; // [statementValue, Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['infrared'] = function(block) {
  var uniqueName = Blockly.Arduino.valueToCode(block, 'NAME', Blockly.Arduino.ORDER_ATOMIC);
  var rxPin = Blockly.Arduino.valueToCode(block, 'rxPin', Blockly.Arduino.ORDER_ATOMIC);
  var txPin = Blockly.Arduino.valueToCode(block, 'txPin', Blockly.Arduino.ORDER_ATOMIC);
  var code = "(|IRPipboy|" + uniqueName + "|" + insideParen(rxPin) + "," + insideParen(txPin) + ",&Timer1|)\n";
  return code;
};

Blockly.Arduino['fireshot'] = function(block) {
  var val = Blockly.Arduino.valueToCode(block, 'VALUE', Blockly.Arduino.ORDER_ATOMIC);
  var name = 'irTransmit3';
  instantiateVariable ( 'IRPipboy ' + name + '(20,3,&Timer1);\n' );
  includeClass ( '#include &ltIR.h&gt' );    
  includeClass ( '#include &ltIRPipboy.h&gt' );
...
Blockly.Arduino['pinselector'] = function(block) {
...
Blockly.Arduino['commentwidget'] = function(block) {
...
Blockly.Arduino.controls_if=function(a){
    var b=0,c="",d,e;
    do e=Blockly.Arduino.valueToCode(a,"IF"+b,Blockly.Arduino.ORDER_NONE)||"false",
       d=Blockly.Arduino.statementToCode(a,"DO"+b)||Blockly.Arduino.PASS,
       c+=(0==b?"if (":"else if (")+e+"){\n" + d + "}\n",++b;
    while(a.getInput("IF"+b)
     
    );
    a.getInput("ELSE")&&(d=Blockly.Arduino.statementToCode(a,"ELSE")||Blockly.Arduino.PASS,c+="else {\n"+d+"}\n");
    return c;
  };
...
Blockly.Arduino['loadobjects'] = function(block) {
  var objects = Blockly.Arduino.statementToCode(block, 'NAME');
  var typeName;
  var uniqueName;
  var pins;
  var code = "";
...
Blockly.Arduino['timerisactive'] = function(block) {
  var value_object = Blockly.Arduino.valueToCode(block, 'OBJECT', Blockly.Arduino.ORDER_ATOMIC);
  var uniqueName = insideChars (value_object,"\"","\"");
  var code = '(' + uniqueName + ' > 0 ) && (millis() < ' + uniqueName + ')';
  return [code, Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['createfiresequence'] = function(block) {
  var value_object = Blockly.Arduino.valueToCode(block, 'OBJECT', Blockly.Arduino.ORDER_ATOMIC);
  var firedata = Blockly.Arduino.valueToCode(block, 'FIREDATA', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino['writepin'] = function(block) {
  var whichpin = Blockly.Arduino.valueToCode(block, 'WHICHPIN', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino['readpin'] = function(block) {
  var whichpin = Blockly.Arduino.valueToCode(block, 'WHICHPIN', Blockly.Arduino.ORDER_ATOMIC);
  var pin = insideParen (whichpin);
...
Blockly.Arduino['define'] = function(block) {
...
Blockly.Arduino['definename'] = function(block) {
  var name = Blockly.Arduino.valueToCode(block, 'NAME', Blockly.Arduino.ORDER_ATOMIC);
  return [name, Blockly.Arduino.ORDER_NONE];
};
...
Blockly.Arduino['settricolor'] = function(block) {
  var color    = block.getFieldValue('COLOR');
  var greenPin = Blockly.Arduino.valueToCode(block, 'GREENPIN', Blockly.Arduino.ORDER_ATOMIC);
  var bluePin  = Blockly.Arduino.valueToCode(block, 'BLUEPIN',  Blockly.Arduino.ORDER_ATOMIC);
  var redPin   = Blockly.Arduino.valueToCode(block, 'REDPIN',   Blockly.Arduino.ORDER_ATOMIC);
  ...
  includeClass ( '#include &ltTriColorLED.h&gt' );
  updateVariable ( name + '.update();' );
  return code;
};

Blockly.Arduino['nextcolor'] = function(block) {
  var greenPin = Blockly.Arduino.valueToCode(block, 'GREENPIN', Blockly.Arduino.ORDER_ATOMIC);
  var bluePin  = Blockly.Arduino.valueToCode(block, 'BLUEPIN',  Blockly.Arduino.ORDER_ATOMIC);
  var redPin   = Blockly.Arduino.valueToCode(block, 'REDPIN',   Blockly.Arduino.ORDER_ATOMIC);
  var name = 'led' + greenPin;
...
Blockly.Arduino['currentcolor'] = function(block) {
  var greenPin = Blockly.Arduino.valueToCode(block, 'GREENPIN', Blockly.Arduino.ORDER_ATOMIC);
  var name = 'led' + greenPin;
...
Blockly.Arduino['isreleased'] = function(block) {
  ...
  includeClass ( '#include &ltButtonPress.h>\n' );
  updateVariable ( name + '.update();' );
  return [code, Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['ispressed'] = function(block) {
  var pin = Blockly.Arduino.valueToCode(block, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
  var name = 'button' + pin
...
Blockly.Arduino['makesound'] = function(block) {
  var pin   = Blockly.Arduino.valueToCode(block, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
  var sound = block.getFieldValue('SOUND');
  
  var name = 'piezo' + pin;
  instantiateVariable ( 'Piezo ' + name + '(' + pin + ');\n' );
  includeClass ( '#include &ltPiezo.h>\n' );
  updateVariable ( name + '.update();' );
  var code = name + '.' + sound + '();\n';
  return code;
};

Blockly.Arduino['stopsound'] = function(block) {
    var pin   = Blockly.Arduino.valueToCode(block, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
    var name = 'piezo' + pin;
    var code = name + '.stop();\n';
    return code;
...
Blockly.Arduino['charpressed'] = function(block) {
  var name = 'chReader';
  var code = name + '.read()';
  instantiateVariable ( 'ChReader ' + name + ';\n' ); 
  includeClass ( '#include &ltChReader.h>\n' );
  updateVariable ( name + '.update();' );
  return [code, Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['lineentered'] = function(block) {
  var name = 'chReader';
...
Blockly.Arduino['cyclecolors'] = function(block) {
  var greenPin = Blockly.Arduino.valueToCode(block, 'GREENPIN', Blockly.Arduino.ORDER_ATOMIC);
  var bluePin  = Blockly.Arduino.valueToCode(block, 'BLUEPIN',  Blockly.Arduino.ORDER_ATOMIC);
  var redPin   = Blockly.Arduino.valueToCode(block, 'REDPIN',   Blockly.Arduino.ORDER_ATOMIC);
  var timeoutValue  = Blockly.Arduino.valueToCode(block, 'TIMEOUT',  Blockly.Arduino.ORDER_ATOMIC);
  var name = 'led' + greenPin;  
...
Blockly.Arduino['stopcyclecolors'] = function(block) {
  var greenPin = Blockly.Arduino.valueToCode(block, 'GREENPIN', Blockly.Arduino.ORDER_ATOMIC);
  var name = 'led' + greenPin;  
...
Blockly.Arduino['timer'] = function(block) {
  ...
  includeClass ( '#include &ltTimer.h&gt' );
  return code;
};

Blockly.Arduino['timerexpired'] = function(block) {
  var value_name = Blockly.Arduino.valueToCode(block, 'NAME', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino['starttimer'] = function(block) {
  var value_name = Blockly.Arduino.valueToCode(block, 'NAME',    Blockly.Arduino.ORDER_ATOMIC);
  var timeout    = Blockly.Arduino.valueToCode(block, 'TIMEOUT', Blockly.Arduino.ORDER_ATOMIC);
  var name = insideChars (value_name,"\"","\"");
...
Blockly.Arduino['displayclear'] = function(block) {
  ...
  includeClass ( '#include &ltSoftwareSerial.h&gt' );    
  includeClass ( '#include &ltDisplaySerial.h&gt' );    
  var code = name + '.clearScreen();\n';
  return code;
};

Blockly.Arduino['displaywrite'] = function(block) {
  var dataPin = Blockly.Arduino.valueToCode(block, 'DATAPIN', Blockly.Arduino.ORDER_ATOMIC);
  var name    = 'display' + dataPin; 
...
Blockly.Arduino['motormove'] = function(block) {
  ...
  includeClass ( '#include &ltMotorControl.h>\n' );
  var code = name + '.motorMove(\"' + direction + '\",\"' + speed + '\");\n';
  return code;
};

Blockly.Arduino['motorleftright'] = function(block) {
  var direction = block.getFieldValue('DIRECTION');
  var speed     = block.getFieldValue('SPEED');
  var pin1      = block.getFieldValue('PIN1');
  var pin2      = block.getFieldValue('PIN2');
...
Blockly.Arduino['irdetected'] = function(block) {
  var rcvPin = Blockly.Arduino.valueToCode(block, 'RCVPIN', Blockly.Arduino.ORDER_ATOMIC);
  var name = 'irReceive' + rcvPin;
  instantiateVariable ( 'IRPipboy ' + name + '(' + rcvPin + ',20,&Timer1);\n' );
  includeClass ( '#include &ltIR.h&gt' );    
  includeClass ( '#include &ltIRPipboy.h&gt' );
  includeClass ( '#include &ltTimerOne.h&gt' );
...
Blockly.Arduino['tostring'] = function (block) {
  var value = Blockly.Arduino.valueToCode(block, 'VALUE', Blockly.Arduino.ORDER_ATOMIC);  
...
Blockly.Arduino ['talkie'] = function (block) {
...
Blockly.Arduino['speakalphabet'] = function (block) { 
...
Blockly.Arduino['speaknumber'] = function (block) {
  var value = Blockly.Arduino.valueToCode(block, 'VALUE', Blockly.Arduino.ORDER_ATOMIC);  
...
Blockly.Arduino['nunchukreadbutton'] = function(block) {
  var button = block.getFieldValue('BUTTON');
  var action = block.getFieldValue('ACTION');  
  var code = 'nunchuk.';  
  includeClass ( '#include &ltArduinoNunchuk.h&gt' );
...
Blockly.Arduino['nunchukjoystickx'] = function(block) {
  var direction = block.getFieldValue('DIRECTION'); 
  includeClass ( '#include &ltArduinoNunchuk.h&gt' );  
  instantiateVariable ( 'ArduinoNunchuk nunchuk = ArduinoNunchuk();' );
  inSetupCode ('  nunchuk.init();'); 
...
Blockly.Arduino['nunchukjoysticky'] = function(block) {
  var direction = block.getFieldValue('DIRECTION'); 
  includeClass ( '#include &ltArduinoNunchuk.h&gt' );  
  instantiateVariable ( 'ArduinoNunchuk nunchuk = ArduinoNunchuk();' );
  inSetupCode ('  nunchuk.init();');   
...
Blockly.Arduino['nunchukjoystickreleased'] = function(block) {
  var direction = block.getFieldValue('DIRECTION'); 
  includeClass ( '#include &ltArduinoNunchuk.h&gt' );  
  instantiateVariable ( 'ArduinoNunchuk nunchuk = ArduinoNunchuk();' );
  inSetupCode ('  nunchuk.init();'); 
  updateVariable ('nunchuk.update();' );
  return ['nunchuk.joystickReleased()', Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['rf433tx'] = function (block) {
...
Blockly.Arduino['rf433rxready'] = function (block) {
  var pin = Blockly.Arduino.valueToCode(block, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino['rf433rx'] = function (block) {
  ...
  return ['msgReceived()', Blockly.Arduino.ORDER_NONE];
};
...
Blockly.Arduino['nrf24l01setup'] = function (block) {
  var ce = Blockly.Arduino.valueToCode(block, 'CE', Blockly.Arduino.ORDER_ATOMIC); 
  var csn = Blockly.Arduino.valueToCode(block, 'CSN', Blockly.Arduino.ORDER_ATOMIC); 
...
Blockly.Arduino['nrf24l01rx'] = function (block) {  
  var whichValue = block.getFieldValue('WhichValue');   
  setupTheCode ('\nString readNrf24l01(bool readLast=false) {\n  static char ch;\n  String response;\n  if (!readLast){ \n    nrf24l01.read(&ch,1);\n  }\n  response = String(ch);\n  return response;\n}' );
  return ['readNrf24l01(' +  whichValue + ')', Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['nrf24l01tx'] = function (block) {  
  return "Hello";
};

Blockly.Arduino['joystickbutton'] = function (block) {
  var action = block.getFieldValue ("ACTION");
  var code = "";
...
Blockly.Arduino['pixelcolor'] = function (block) {
  var color = block.getFieldValue ("COLOR"); 
  var code = "pixels." + color + "();\n";    
  return code;
};

Blockly.Arduino['pixelscan'] = function (block) {
...
Blockly.Arduino['pixelblink'] = function (block) {
...
Blockly.Arduino['pixelminus'] = function (block) {
  return "pixels.minus();\n"; 
};

Blockly.Arduino['pixelplus'] = function (block) {
  return "pixels.plus();\n"; 
};
...
Blockly.Arduino['ps2yaction'] = function (block) {
...
Blockly.Arduino['ps2fire'] = function (block) {   
  return ["ps2Wireless.newFire == \"PRESSED\"", Blockly.Arduino.ORDER_NONE];
};
...
Blockly.Arduino['ShiftRegSetup'] = function (block) {
    var srNumRegisters = Blockly.Arduino.valueToCode(block, 'SrNumRegisters', Blockly.Arduino.ORDER_ATOMIC);
    var srDataPin = Blockly.Arduino.valueToCode(block, 'SrDataPin', Blockly.Arduino.ORDER_ATOMIC);
    var srClockPin = Blockly.Arduino.valueToCode(block, 'SrClockPin', Blockly.Arduino.ORDER_ATOMIC);
    var srLatchPin = Blockly.Arduino.valueToCode(block, 'SrLatchPin', Blockly.Arduino.ORDER_ATOMIC);

    includeClass ('#include &ltShiftRegister74HC595.h&gt' );
...
Blockly.Arduino['ShiftRegSet'] = function (block) {
    var srRegister = Blockly.Arduino.valueToCode(block, 'SrRegister', Blockly.Arduino.ORDER_ATOMIC);
    var value = block.getFieldValue ("VALUE");
    var code = 'shiftRegister.set(' + srRegister + ', ' + value + ');\n';
    return code;
};

Blockly.Arduino['ShiftRegGet'] = function (block) {
    var srRegister = Blockly.Arduino.valueToCode(block, 'SrRegister', Blockly.Arduino.ORDER_ATOMIC);
    return ['shiftRegister.get(' + srRegister + ')', Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['ShiftRegSetAll'] = function (block) {
    var srValue = Blockly.Arduino.valueToCode(block, 'SrValue', Blockly.Arduino.ORDER_ATOMIC);
    var code = 'registerValues[0] = { ' + srValue + ' };\nshiftRegister.setAll(registerValues);\n';
    return code;
};

Blockly.Arduino['ShiftRegSetAllLow'] = function (block) {
    var code = 'shiftRegister.setAllLow();\n';
    return code;
};

Blockly.Arduino['ShiftRegSetAllHigh'] = function (block) {
    var code = 'shiftRegister.setAllHigh();\n';
    return code;
};

Blockly.Arduino['ShiftRegGetAll'] = function (block) {
    return ['shiftRegister.getAll()', Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['ShiftRegSetNoUpdate'] = function (block) {
    var srRegister = Blockly.Arduino.valueToCode(block, 'SrRegister', Blockly.Arduino.ORDER_ATOMIC);
    var value = block.getFieldValue ("VALUE");
...
Blockly.Arduino['ShiftRegUpdateRegisters'] = function (block) {
